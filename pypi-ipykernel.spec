...
Provides: ipykernel
Provides: ipykernel-python
Provides: ipykernel-python3
...
%prep
%setup -q -n ipykernel-6.6.1
cd %{_builddir}/ipykernel-6.6.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641445932
...
cp %{_builddir}/ipykernel-6.6.1/COPYING.md %{buildroot}/usr/share/package-licenses/pypi-ipykernel/a8d9e56558dabe10c8e716d79a4b01dcb6cf950f
