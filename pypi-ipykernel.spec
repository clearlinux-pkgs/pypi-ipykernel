...
Source0  : https://files.pythonhosted.org/packages/5d/8a/5060f04d76e70dfdfe342c58a59c9c558c9c21e7fe2d72649f8c060de75b/ipykernel-6.26.0.tar.gz
...
%prep
%setup -q -n ipykernel-6.26.0
cd %{_builddir}/ipykernel-6.26.0
pushd ..
cp -a ipykernel-6.26.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698244507
