...
Source0  : https://files.pythonhosted.org/packages/8f/d8/6300fbbc6c211f51c833a0b8def7df9904eec315a2880f204e54dc117304/ipykernel-6.29.4.tar.gz
...
%prep
%setup -q -n ipykernel-6.29.4
cd %{_builddir}/ipykernel-6.29.4
pushd ..
cp -a ipykernel-6.29.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711640728
