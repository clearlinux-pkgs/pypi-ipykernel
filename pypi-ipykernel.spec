...
Source0  : https://files.pythonhosted.org/packages/ab/37/ddef2ece768f4d457d8f7ac067d2857ff39f7e74f61568c6e9d7f6da79c3/ipykernel-6.29.3.tar.gz
...
%prep
%setup -q -n ipykernel-6.29.3
cd %{_builddir}/ipykernel-6.29.3
pushd ..
cp -a ipykernel-6.29.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708992565
