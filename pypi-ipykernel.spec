...
Source0  : https://files.pythonhosted.org/packages/5d/b3/b0e1ee12ce6035de28b766d62398b85b13483a3f88f5832240a76718ea27/ipykernel-6.8.0.tar.gz
...
%prep
%setup -q -n ipykernel-6.8.0
cd %{_builddir}/ipykernel-6.8.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643816630
...
cp %{_builddir}/ipykernel-6.8.0/COPYING.md %{buildroot}/usr/share/package-licenses/pypi-ipykernel/a8d9e56558dabe10c8e716d79a4b01dcb6cf950f
