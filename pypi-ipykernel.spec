...
Source0  : https://files.pythonhosted.org/packages/03/55/644139aaa3237b0c6c8e3296462b2214cf3423d41c48e812db4555d42573/ipykernel-6.29.0.tar.gz
...
%prep
%setup -q -n ipykernel-6.29.0
cd %{_builddir}/ipykernel-6.29.0
pushd ..
cp -a ipykernel-6.29.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705502351
