...
Version  : 6.21.3
Release  : 112
URL      : https://files.pythonhosted.org/packages/df/04/a9709daeb4ca855f69e162a4fd3b87aabfa7856eb8eb29065f720cceeb4f/ipykernel-6.21.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/df/04/a9709daeb4ca855f69e162a4fd3b87aabfa7856eb8eb29065f720cceeb4f/ipykernel-6.21.3.tar.gz
...
%prep
%setup -q -n ipykernel-6.21.3
cd %{_builddir}/ipykernel-6.21.3
pushd ..
cp -a ipykernel-6.21.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678118454
