...
Source0  : https://files.pythonhosted.org/packages/e0/22/d6c7267ebf529853bfc786eea6840c24164634d008d4a58ec4ddf0f8a633/ipykernel-6.9.1.tar.gz
...
%prep
%setup -q -n ipykernel-6.9.1
cd %{_builddir}/ipykernel-6.9.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645042451
...
cp %{_builddir}/ipykernel-6.9.1/COPYING.md %{buildroot}/usr/share/package-licenses/pypi-ipykernel/a8d9e56558dabe10c8e716d79a4b01dcb6cf950f
