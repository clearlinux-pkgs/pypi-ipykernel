...
Source0  : https://files.pythonhosted.org/packages/4f/68/d18cf6d4130ed5719a478aa976ac4affcf8c7f687844b55b67b4be9ade76/ipykernel-6.21.1.tar.gz
...
%prep
%setup -q -n ipykernel-6.21.1
cd %{_builddir}/ipykernel-6.21.1
pushd ..
cp -a ipykernel-6.21.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676053457
