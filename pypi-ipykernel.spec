...
Source0  : https://files.pythonhosted.org/packages/f5/e9/fb451fa1c2439c8ad3670cc341b7837f2a8a7749de45720bf735f9c74666/ipykernel-6.7.0.tar.gz
...
%prep
%setup -q -n ipykernel-6.7.0
cd %{_builddir}/ipykernel-6.7.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642179501
...
cp %{_builddir}/ipykernel-6.7.0/COPYING.md %{buildroot}/usr/share/package-licenses/pypi-ipykernel/a8d9e56558dabe10c8e716d79a4b01dcb6cf950f
